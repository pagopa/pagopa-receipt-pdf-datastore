...
//import it.gov.pagopa.receipt.pdf.datastore.exception.*;
...
//
//public class TransactionEventToCartReceiptUtils {
//
...
//
//
//    private TransactionEventToCartReceiptUtils() {
//    }
//
//    public static CartForReceipt retrieveCartAndSendReceipt(
//            String eventId,
//            ExecutionContext context,
//            @NotNull CartReceiptsCosmosClient cartReceiptCosmosClient,
//            Receipt receipt,
//            Logger logger
//    ) throws BizEventNotFoundException, BizEventBadRequestException, ReceiptNotFoundException, PDVTokenizerException, JsonProcessingException, CartNotFoundException {
//
//        CartForReceipt cartItem = cartReceiptCosmosClient.getCartItem(eventId);
//
//        // check total notice
//        // Checks if the instance of Biz Event is in status DONE and contains all the required information to process in the receipt generation
//
//
//        if (isBizEventInvalid(cartItem, context, logger)) {
//            throw new BizEventBadRequestException("BizEvent not valid");
//        }
//
//        if (!hasValidTotalNotice(cartItem, context, logger)) {
...
//            receipt = createReceipt(cartItem, bizEventToReceiptService, logger);
//            if (isReceiptStatusValid(receipt)) {
//                bizEventToReceiptService.handleSaveReceipt(receipt);
//
//                if (isReceiptStatusValid(receipt)) {
//                    bizEventToReceiptService.handleSendMessageToQueue(Collections.singletonList(cartItem), receipt);
//
//                    return receipt;
//                }
//            }
